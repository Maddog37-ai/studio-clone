      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-muted-foreground">Assisted Closes</p>
                <p className="text-2xl font-bold text-green-600">{teamTotals.totalAssistedCloses}</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl font-bold text-purple-600">
                  {setterMetrics.length > 0 ? setterMetrics[0].bestDay : 'Monday'}
                </p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-orange-600">{teamTotals.todayTotal}</p>
              </div>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-muted-foreground">WTD</p>
                <p className="text-2xl font-bold text-cyan-600">{teamTotals.wtdTotal}</p>
              </div>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-muted-foreground">MTD</p>
                <p className="text-2xl font-bold text-pink-600">{teamTotals.mtdTotal}</p>
              </div>
