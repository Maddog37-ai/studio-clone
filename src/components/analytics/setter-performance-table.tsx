          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b">
                ...
                <th className="text-right p-2">Sits</th>
                <th className="text-right p-2">Sit Rate</th>
                <th className="text-right p-2">Failed Credit</th>
                <th className="text-right p-2">Immediate</th>
                <th className="text-right p-2">Scheduled</th>
                <th className="text-right p-2">Cancel/No Show</th>
            ...
            <tbody>
              {setterPerformance
                ...
                .map((setter) => (
                  ...
                  >
                    <td className="p-2 font-medium">{setter.name}</td>
                    <td className="text-right p-2">{setter.totalLeads}</td>
                    <td className="text-right p-2">{setter.sitCount}</td>
                    <td className="text-right p-2">{setter.sitRate.toFixed(1)}%</td>
                    ...
                    <td className="text-right p-2">{setter.avgLeadsPerDay.toFixed(1)}</td>
                  </tr>
                ))}
            </tbody>
          </table>
